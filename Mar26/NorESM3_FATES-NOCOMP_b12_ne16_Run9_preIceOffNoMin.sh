...
casename="n1850.$resolution.$noresmversion.Run9_preIceOffNoMinOsl.`date +"%Y-%m-%d"`"
...
then
	...
	cp /cluster/home/kjetisaa/Run_NorESM_script/Mar26/microp_aero.F90 $workpath$casename/SourceMods/src.cam/
	cp /cluster/home/kjetisaa/Run_NorESM_script/Mar26/oslo_aero_microp.F90 $workpath$casename/SourceMods/src.cam/
        #XML changes

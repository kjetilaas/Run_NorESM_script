...
#NorESM dir
noresmrepo="NorESM_3_0_beta12a"
noresmversion="noresm3_0_beta12a"

resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37
casename="n1850.$resolution.$noresmversion.Run10_hyb.`date +"%Y-%m-%d"`"
compset="1850_CAM70%LT%NORESM%CAMoslo_CLM60%FATES-NOCOMP_CICE_BLOM%HYB%ECO_MOSART_DGLC%NOEVOLVE_SWAV_SESP"
refcase="n1850.ne16pg3_tn14.noresm3_0_beta12.Run9.2026-03-11" #Update here
refyear="0926" #Update here

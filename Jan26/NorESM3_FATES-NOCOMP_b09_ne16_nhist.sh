...
casename="nhist.$resolution.$noresmversion.Test1.`date +"%Y-%m-%d"`"
compset="HIST_CAM70%LT%NORESM%CAMoslo_CLM60%FATES-NOCOMP_CICE_BLOM%HYB%ECO_MOSART_DGLC%NOEVOLVE_SWAV_SESP"
...
then
    ...
    then    
        ...
        ./xmlchange RUN_REFDATE=0216-01-01 #Update here
...
then
    ...
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30/rest/0216-01-01-00000/*.r*.nc /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30/rest/0216-01-01-00000/rpointer.*0216-01-01-00000 /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30/rest/0216-01-01-00000/n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30.cam.i.0216-01-01-00000.nc /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here

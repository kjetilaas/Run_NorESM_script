...
casename="n1850.$resolution.$noresmversion.Run6.`date +"%Y-%m-%d"`"
compset="1850_CAM70%LT%NORESM%CAMoslo_CLM60%FATES-NOCOMP_CICE_BLOM%HYB%ECO_MOSART_DGLC%NOEVOLVE_SWAV_SESP"
refcase="n1850.ne16pg3_tn14.noresm3_0_beta09.Run5.2026-01-08" #Update here
refyear="0406" #Update here

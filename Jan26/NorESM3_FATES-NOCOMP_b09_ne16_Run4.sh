...
casename="n1850.$resolution.$noresmversion.Run4.`date +"%Y-%m-%d"`"
...
then
    ...
    then    
        ...
        ./xmlchange RUN_STARTDATE=0221-01-01   #Update here
        ./xmlchange RUN_REFCASE=n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30  #Update here (also in copy restarts below!!!)
        ./xmlchange RUN_REFDATE=0221-01-01 #Update here
...
hist_fincl1 = "FATES_LITTER_IN", "FATES_LITTER_OUT", "FATES_SEEDS_IN_EXTERN_EL", "TOTSOMC", "TOT_WOODPRODC", "TOT_WOODPRODC_LOSS"
EOF
...
then
    ...
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30/rest/0221-01-01-00000/*.r*.nc /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30/rest/0221-01-01-00000/rpointer.*0221-01-01-00000 /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30/rest/0221-01-01-00000/n1850.ne16pg3_tn14.noresm3_0_beta09.Run3.2025-12-30.cam.i.0221-01-01-00000.nc /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here

...
casename="n1850esm.$resolution.hybrid_CLM6BGC-CROP.3.0a06a.20250624"
compset="1850_CAM70%LT%NORESM%CAMoslo_CLM60%BGC-CROP_CICE_BLOM%HYB%ECO_MOSART_DGLC%NOEVOLVE_SWAV_SESP_BGC%BPRP"

...
casename="i1850.$resolution.fatesnocomp.$noresmversion.steadystateLU_fromNOpotveg.20250527"
...
then
    ...
    then    
        ...
        echo "finidat = '/cluster/work/users/kjetisaa/archive/i1850.f45_f45_mg37.fatesnocomp.noresm3_0_alpha03c.NOpotveg_coldstart.20250526/rest/0011-01-01-00000/i1850.f45_f45_mg37.fatesnocomp.noresm3_0_alpha03c.NOpotveg_coldstart.20250526.clm2.r.0011-01-01-00000.nc'" >> $workpath$casename/user_nl_clm
        ...
        echo "fluh_timeseries = '/cluster/shared/noresm/inputdata/share_kjetil/LU_data_CMIP7/LUH2_states_transitions_management.timeseries_4x5_hist_steadystate_1850_2025-05-22_cdf5.nc'" >> $workpath$casename/user_nl_clm                
    fi
fi

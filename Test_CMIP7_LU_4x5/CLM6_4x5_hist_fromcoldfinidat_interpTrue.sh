...
casename="ihist.$resolution.clm6bgc.$noresmversion.fromcoldstartfinidat_interpTrue.20250530"

compset="HIST_DATM%CRUJRA2024_CLM60%BGC_SICE_SOCN_SROF_SGLC_SWAV_SESP"
...
then
    ...
    then    
        ...
        echo "finidat = '/cluster/work/users/kjetisaa/archive/i1850.f45_f45_mg37.clm6bgc.noresm3_0_alpha03c.coldstart.20250528/rest/0003-01-01-00000/i1850.f45_f45_mg37.clm6bgc.noresm3_0_alpha03c.coldstart.20250528.clm2.r.0003-01-01-00000.nc'" >> $workpath$casename/user_nl_clm                

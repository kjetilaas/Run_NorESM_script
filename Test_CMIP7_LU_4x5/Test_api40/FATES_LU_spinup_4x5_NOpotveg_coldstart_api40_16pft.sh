...
casename="i1850.$resolution.fatesnocomp.$noresmversion.NOpotveg_coldstart_api40_16pft.20250617"
...
then
    ...
    then    
        ...
        echo "fates_paramfile = '/cluster/home/kjetisaa/Run_NorESM_script/Test_CMIP7_LU_4x5/Test_api40/fates_params_api.40.0.0_16pft_c250617_noresm_v16.nc'" >> $workpath$casename/user_nl_clm

...
casename="ihist.$resolution.fatesnocomp.$noresmversion.hist_from_steadystateLU_16pft_interpTrue.20250530"
...
then
    ...
    then    
        ...
        echo "finidat = '/cluster/work/users/kjetisaa/archive/i1850.f45_f45_mg37.fatesnocomp.noresm3_0_alpha03c.constLU_coldstart.20250526/rest/0011-01-01-00000/i1850.f45_f45_mg37.fatesnocomp.noresm3_0_alpha03c.constLU_coldstart.20250526.clm2.r.0011-01-01-00000.nc'" >> $workpath$casename/user_nl_clm        
        ...
        echo "flanduse_timeseries = '/cluster/shared/noresm/inputdata/lnd/clm2/surfdata_esmf/ctsm5.3.0/landuse.timeseries_4x5_SSP2-4.5_1850-2100_16pfts_c241007.nc'" >> $workpath$casename/user_nl_clm #From https://svn-ccsm-inputdata.cgd.ucar.edu/trunk/inputdata/lnd/clm2/surfdata_esmf/ctsm5.3.0/
        echo "use_init_interp = .true." >> $workpath$casename/user_nl_clm
    fi
fi

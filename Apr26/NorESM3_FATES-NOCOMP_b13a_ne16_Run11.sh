...
casename="n1850.$resolution.$noresmversion.Run11.`date +"%Y-%m-%d"`"
...
then
    ...
    then
        ...
        #sed -i 's/fxtag = v1.12.31/fxtag = v1.12.32/g' .gitmodules
        #echo "Updated .gitmodules to use fxtag = v1.12.31 for BLOM:"

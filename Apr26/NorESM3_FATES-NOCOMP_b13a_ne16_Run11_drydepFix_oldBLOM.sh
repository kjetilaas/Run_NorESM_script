...
#NorESM dir
noresmrepo="NorESM_3_0_beta13a_drydepFix_oldBLOM"
noresmversion="noresm3_0_beta13a"

resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37
casename="n1850.$resolution.$noresmversion.Run11_drydep_oldBLOM.`date +"%Y-%m-%d"`"
...
then
    ...
    then
        ...
        sed -i 's/fxtag = v1.12.36/fxtag = v1.12.32/g' .gitmodules
        echo "Updated .gitmodules to use fxtag = v1.12.32 for BLOM:"
        grep -i -n 'v1.12.32' .gitmodules        
	./bin/git-fleximod update

	cd components/clm/
        git remote add matvey https://github.com/mvdebolskiy/ctsm
        git fetch matvey
        git checkout drydep-fix-ctsm
	cd src/fates/
	git remote add matvey_fates https://github.com/mvdebolskiy/fates
        git fetch matvey_fates
        git checkout drydep-fix
...
fincl3 =  'CLDTOT_ISCCP', 'CLHMODIS', 'CLLMODIS', 'CLIMODIS', 'CLMODIS', 'CLMMODIS', 'CLTMODIS', 'CLWMODIS', 'IWPMODIS','CLWMODIS', 'LWPMODIS', 'IWPMODIS', 'MEANPTOP_ISCCP', 'MEANTB_ISCCP', 'PCTMODIS', 'MEANCLDALB_ISCCP', 'FISCCP1_COSP', 'TAUIMODIS', 'REFFCLWMODIS', 'REFFCLIMODIS', 'TAUTMODIS', 'TAUWMODIS'
EOF
...
fates_paramfile = '/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci3_api1_c260123_drydep.nc'

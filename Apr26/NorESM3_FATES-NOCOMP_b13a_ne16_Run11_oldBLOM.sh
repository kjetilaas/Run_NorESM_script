...
#NorESM dir
noresmrepo="NorESM_3_0_beta13a_oldBLOM"
noresmversion="noresm3_0_beta13a"

resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37
casename="n1850.$resolution.$noresmversion.Run11_oldBLO_oldBLOMv32.`date +"%Y-%m-%d"`"
...
EOF
	...
	sed -i '10i\#SBATCH --exclude=b3269' .case.run

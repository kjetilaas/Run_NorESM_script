...
casename="i2000.$resolution.fatesnocomp.$noresmversion.20250519_landOnly_restart"
...
then
    ...
    then    
        ...
        echo "finidat = '/cluster/work/users/kjetisaa/archive/i2000.ne30pg3_tn14.fatesnocomp.noresm3_0_alpha03.20250519_landOnly_nofinit/rest/2002-01-01-00000/i2000.ne30pg3_tn14.fatesnocomp.noresm3_0_alpha03.20250519_landOnly_nofinit.clm2.r.2002-01-01-00000.nc'" >> $workpath$casename/user_nl_clm        
    fi   
fi

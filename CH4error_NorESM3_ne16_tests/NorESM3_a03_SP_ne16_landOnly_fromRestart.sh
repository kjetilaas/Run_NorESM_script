...
casename="i1850.$resolution.fatesnocomp.$noresmversion.20250514_landOnly_fromRestart_SP"
...
then
    ...
    then    
        ...
        echo "use_fates_sp=.true." >> $workpath$casename/user_nl_clm
        echo "use_fates_luh = .false." >> $workpath$casename/user_nl_clm           
        echo "finidat = '/cluster/work/users/kjetisaa/archive/i1850.ne16pg3_tn14.fatesnocomp.noresm3_0_alpha03.20250514_landOnly_nofinit_SP/rest/0002-01-01-00000/i1850.ne16pg3_tn14.fatesnocomp.noresm3_0_alpha03.20250514_landOnly_nofinit_SP.clm2.r.0002-01-01-00000.nc'" >> $workpath$casename/user_nl_clm        

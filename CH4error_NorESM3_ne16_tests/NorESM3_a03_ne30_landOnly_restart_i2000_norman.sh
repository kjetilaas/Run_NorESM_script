...
casename="i2000.$resolution.fatesnocomp.$noresmversion.20250519_landOnly_restart_norman"
...
then
    ...
    then    
        ...
        echo "fates_radiation_model = 'norman'" >> $workpath$casename/user_nl_clm
        echo "finidat = '/cluster/work/users/kjetisaa/archive/i2000.ne30pg3_tn14.fatesnocomp.noresm3_0_alpha03.20250519_lancpdOnly_nofinit/rest/2002-01-01-00000/i2000.ne30pg3_tn14.fatesnocomp.noresm3_0_alpha03.20250519_landOnly_nofinit.clm2.r.2002-01-01-00000.nc'" >> $workpath$casename/user_nl_clm        
    fi   
fi

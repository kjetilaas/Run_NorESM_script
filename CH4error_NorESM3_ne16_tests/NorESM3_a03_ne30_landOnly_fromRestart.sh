...
then
    ...
    then    
        ...
        echo "finidat = '/cluster/work/users/kjetisaa/archive/i1850.ne30pg3_tn14.fatesnocomp.noresm3_0_alpha03.20250514_landOnly_nofinit/rest/0002-01-01-00000/i1850.ne30pg3_tn14.fatesnocomp.noresm3_0_alpha03.20250514_landOnly_nofinit.clm2.r.0002-01-01-00000.nc'" >> $workpath$casename/user_nl_clm        

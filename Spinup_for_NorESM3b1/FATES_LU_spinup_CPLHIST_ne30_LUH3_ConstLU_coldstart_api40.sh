...
casename="i1850.$resolution.fatesnocomp.$noresmversion.CPLHIST_LUH3_ConstLU_coldstart_v21_wFCO2.20250628"
...
then
    ...
    then    
        ...
        echo "flandusepftdat = '/cluster/shared/noresm/inputdata/LU_data_CMIP7/fates_landuse_pft_map_to_surfdata_ne30np4_250530_cdf5.nc'" >> $workpath$casename/user_nl_clm
        ...
        echo "fluh_timeseries = '/cluster/shared/noresm/inputdata/LU_data_CMIP7/LUH3_timeseries_to_surfdata_ne30np4_250530_cdf5.nc'" >> $workpath$casename/user_nl_clm                
    fi
fi

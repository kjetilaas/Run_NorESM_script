...
casename="i1850.$resolution.fatesnocomp.$noresmversion.CPLHIST_noLU_coldstart_v25u.`date +"%Y-%m-%d"`"
...
then
    ...
    then    
        ...
        ./xmlchange DATM_CPLHIST_CASE=n1850.ne16pg3_tn14.nor3_b01-cplhist.20250716
        ./xmlchange DATM_CPLHIST_DIR=/cluster/work/users/olivie/archive/n1850.ne16pg3_tn14.nor3_b01-cplhist.20250716/cpl/hist/
        ./xmlchange DATM_PRESNDEP=none
        ./xmlchange DATM_YR_START=101
        ./xmlchange DATM_YR_END=200
        ...
        echo "paramfile = '/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/ctsm60_params.200905_v25u.nc'" >> $workpath$casename/user_nl_clm
        echo "fates_paramfile = '/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/fates_params_api.40.0.0_14pft_c250905_noresm_v25u.nc'" >> $workpath$casename/user_nl_clm
    fi
fi

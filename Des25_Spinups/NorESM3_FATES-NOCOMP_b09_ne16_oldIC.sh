...
then
    ...
    then    
        ...
        ./xmlchange RUN_STARTDATE=0001-01-01   #Update here
...
finidat = '/cluster/work/users/kjetisaa/archive/i1850.ne16pg3_tn14.ctsm5.4.002_noresm_v1.CPLHIST_postADspinup_SHORT.2025-12-17/rest/0071-01-01-00000/i1850.ne16pg3_tn14.ctsm5.4.002_noresm_v1.CPLHIST_postADspinup_SHORT.2025-12-17.clm2.r.0071-01-01-00000.nc'

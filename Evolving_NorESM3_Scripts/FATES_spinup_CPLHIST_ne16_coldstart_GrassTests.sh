...
casename="i1850.$resolution.$noresmversion.CPLHIST_nograze.`date +"%Y-%m-%d"`"
...
then
    ...
    then    
        ...
        #cp /cluster/work/users/kjetisaa/ppe-scramble-tag-for-ctsm-on-norems3-beta04/src/fates/biogeophys/FatesPlantRespPhotosynthMod.F90 $workpath$casename/SourceMods/src.clm/
...
fates_paramfile = '/cluster/home/kjetisaa/Temp_param/fates_params_sci.1.85.1_api.40.0.0_14pft_nor_sci1_api1_c251031_nograze.nc'

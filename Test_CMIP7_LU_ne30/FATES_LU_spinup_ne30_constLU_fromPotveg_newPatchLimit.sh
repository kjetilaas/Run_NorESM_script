...
casename="i1850.$resolution.fatesnocomp.$noresmversion.constLU_fromPotveg_newPatchLimit.20250604"
...
then
    ...
    then    
        ...
        echo "Copying modified FatesConstantsMod.F90 to SourceMods"
        cp /cluster/home/kjetisaa/Run_NorESM_script/Test_CMIP7_LU_ne30/FatesConstantsMod.F90 $workpath$casename/SourceMods/src.clm/
        #XML changes
        ...
        echo "flandusepftdat = '/cluster/shared/noresm/inputdata/share_kjetil/LU_data_CMIP7/fates_landuse_pft_map_to_surfdata_ne30np4_250530_cdf5.nc'" >> $workpath$casename/user_nl_clm
        ...
        echo "finidat = '/cluster/work/users/kjetisaa/archive/i1850.ne30pg3_tn14.fatesnocomp.noresm3_0_alpha03c.potveg_coldstart.20250602/rest/0031-01-01-00000/i1850.ne30pg3_tn14.fatesnocomp.noresm3_0_alpha03c.potveg_coldstart.20250602.clm2.r.0031-01-01-00000.nc'" >> $workpath$casename/user_nl_clm
        ...
        echo "fluh_timeseries = '/cluster/shared/noresm/inputdata/share_kjetil/LU_data_CMIP7/LUH2_states_transitions_management.timeseries_ne30_hist_steadystate_1850_2025-06-03_cdf5.nc'" >> $workpath$casename/user_nl_clm                        
    fi
fi

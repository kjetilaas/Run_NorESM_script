...
casename="n1850.$resolution.$noresmversion.landAndCAMupdate.`date +"%Y-%m-%d"`"
...
then
    ...
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.hybrid_fates-nocomp.noresm3_0_beta03a.2025-10-10/rest/0121-01-01-00000/*.r*.nc /cluster/work/users/kjetisaa/noresm/$casename/run/
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.hybrid_fates-nocomp.noresm3_0_beta03a.2025-10-10/rest/0121-01-01-00000/rpointer.*0121-01-01-00000 /cluster/work/users/kjetisaa/noresm/$casename/run/

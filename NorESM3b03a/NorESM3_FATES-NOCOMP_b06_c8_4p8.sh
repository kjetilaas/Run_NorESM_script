...
casename="n1850.$resolution.hybrid_fates-nocomp.$noresmversion.Best_c8_4p8.`date +"%Y-%m-%d"`"
...
finidat = '/cluster/work/users/rosief/archive/i1850.ne16pg3_tn14.fatesnocomp.noresm3_0_beta04.CPLHIST_medlynfire_landuse.2025-11-11/rest/0060-01-01-00000/i1850.ne16pg3_tn14.fatesnocomp.noresm3_0_beta04.CPLHIST_medlynfire_landuse.2025-11-11.clm2.r.0060-01-01-00000.nc'
EOF

...
casename="n1850.$resolution.$noresmversion.CPLHIST.b06_settings.`date +"%Y-%m-%d"`"  #Update here
...
then
    ...
    then    
        ...
        ./xmlchange RUN_STARTDATE=0391-01-01,START_TOD=00000    #Update here
        ./xmlchange RUN_REFCASE=n1850.ne16pg3_tn14.noresm3_0_beta03b.CPLHIST.2025-10-29 #Update here        
        ./xmlchange RUN_REFDATE=0391-01-01,RUN_REFTOD=00000 #Update here
        ./xmlchange GET_REFCASE=FALSE
        ./xmlchange DRV_RESTART_POINTER=rpointer.cpl.0391-01-01-00000 #Update here
...
fates_paramfile = '/cluster/home/kjetisaa/Temp_param/fates_params_sci.1.85.1_api.40.0.0_14pft_nor_sci1_api1_c251031_b3bCompatible.nc'

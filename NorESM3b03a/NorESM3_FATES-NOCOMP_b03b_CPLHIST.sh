...
casename="n1850.$resolution.$noresmversion.CPLHIST.`date +"%Y-%m-%d"`"  #Update here
...
then
    ...
    then    
        ...
        ./xmlchange RUN_STARTDATE=0291-01-01,START_TOD=00000    #Update here
        ./xmlchange RUN_REFCASE=n1850.ne16pg3_tn14.noresm3_0_beta03b.BLOMalbAndBrine.2025-10-24 #Update here
        ./xmlchange RUN_REFDATE=0291-01-01,RUN_REFTOD=00000 #Update here
        ./xmlchange GET_REFCASE=FALSE
        ./xmlchange DRV_RESTART_POINTER=rpointer.cpl.0291-01-01-00000 #Update here
...
cat <<EOF >> user_nl_clm
fates_paramfile = '/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/fates_params_api.40.0.0_14pft_c250923_noresm_v26i.nc'
paramfile = '/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/ctsm60_params.250923_v26j.nc'
EOF

...
casename="n1850.$resolution.$noresmversion.Best_c8_4p7.`date +"%Y-%m-%d"`"
...
then
    ...
    then    
        ...
        ./xmlchange RUN_STARTDATE=0471-01-01   #Update here
        ./xmlchange RUN_REFCASE=n1850.ne16pg3_tn14.hybrid_fates-nocomp.noresm3_0_beta06.Best_c8_4p8.2025-11-26  #Update here
        ./xmlchange RUN_REFDATE=0471-01-01 #Update here
    	...
    	./xmlchange DRV_RESTART_POINTER=rpointer.cpl.0471-01-01-00000 #updates needed
...
then
    ...
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.hybrid_fates-nocomp.noresm3_0_beta06.Best_c8_4p8.2025-11-26/rest/0471-01-01-00000/*.r*.nc /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.hybrid_fates-nocomp.noresm3_0_beta06.Best_c8_4p8.2025-11-26/rest/0471-01-01-00000/rpointer.*0471-01-01-00000 /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here
    cp /cluster/work/users/kjetisaa/archive/n1850.ne16pg3_tn14.hybrid_fates-nocomp.noresm3_0_beta06.Best_c8_4p8.2025-11-26/rest/0471-01-01-00000/n1850.ne16pg3_tn14.hybrid_fates-nocomp.noresm3_0_beta06.Best_c8_4p8.2025-11-26.cam.i.0471-01-01-00000.nc /cluster/work/users/kjetisaa/noresm/$casename/run/ #Update here

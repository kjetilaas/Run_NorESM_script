...
#NorESM dir
noresmrepo="NorESM_3_0_beta04_PPEsetup"
noresmversion="noresm3_0_beta04"

resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37
casename="n1850.$resolution.hybrid_fates-nocomp.$noresmversion.PPEscramble_test.`date +"%Y-%m-%d"`"
...
then
    ...
    then    
        ...
        ./xmlchange NTASKS=128,NTASKS_OCN=128,NTASKS_ICE=128,NTASKS_LND=128,ROOTPE_OCN=128,ROOTPE_LND=128
